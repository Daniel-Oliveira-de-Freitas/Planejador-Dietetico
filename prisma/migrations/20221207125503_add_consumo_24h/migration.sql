...
*/
-- CreateTable
CREATE TABLE "Consumo24h" (
    "id" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT
);

-- CreateTable
CREATE TABLE "TipoDeRefeicao" (
    "id" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
    "nome" TEXT NOT NULL
);

-- CreateTable
CREATE TABLE "RefeicaoConsumo24h" (
    "id" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
...
INSERT INTO "new_Paciente" ("consumoHabitualId", "habitosDeVidaId", "id", "nome") SELECT "consumoHabitualId", "habitosDeVidaId", "id", "nome" FROM "Paciente";
DROP TABLE "Paciente";

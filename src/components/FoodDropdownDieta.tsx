...
const FoodDropdownDieta = (props: FoodDropdownProps) => {
  const { paciente, setPaciente } = useContext(PacienteContext);
  const removeItem = (id: number, foodArray: RefeicaoDietaComAlimentos[]) => {
    return props.setConsumo(foodArray.filter(food => food.id !== id));
  };
  const [dieta, setDieta] = useState<RefeicaoDietaComAlimentos[]>();
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className='whitespace-nowrap py-4 text-sky-900'>
                              ...
                              {alimento.medida} - {alimento.quantidade}g
                            </td>
                            <td className='whitespace-nowrap py-4 text-sky-900'>
                              {convertMacros(
                                alimento.alimentoTACO,
                            ...
                            <td className='whitespace-nowrap py-4 text-sky-900'>
                              {convertMacros(alimento.alimentoTACO, alimento.quantidade, 0, 'dieta')
...
export default FoodDropdownDieta;
